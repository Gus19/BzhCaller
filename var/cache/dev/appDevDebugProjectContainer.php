...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'war.dates.calc' => 'getWar_Dates_CalcService',
            'war.targets.create' => 'getWar_Targets_CreateService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BzhCoreBundle', ($this->targetDirs[3].'\\app/Resources/BzhCoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BzhCoreBundle', ($this->targetDirs[3].'\\src\\Bzh\\CoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BzhWarBundle', ($this->targetDirs[3].'\\app/Resources/BzhWarBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BzhWarBundle', ($this->targetDirs[3].'\\src\\Bzh\\WarBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BzhStatsBundle', ($this->targetDirs[3].'\\app/Resources/BzhStatsBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BzhStatsBundle', ($this->targetDirs[3].'\\src\\Bzh\\StatsBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('aPCXZ+bJ5f', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oDy2ZoITbK', '', 'ddbik7OFYQSf0Sq+FdHLUQ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TzrpJFrlt7', '', 'ddbik7OFYQSf0Sq+FdHLUQ', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('evhqKxgTAf', '', 'ddbik7OFYQSf0Sq+FdHLUQ', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'bzhcaller', 'user' => 'postgres', 'password' => 322158, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $g, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Bzh\\CoreBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Bzh\\WarBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Bzh\\CoreBundle\\Entity');
        $c->addDriver($b, 'Bzh\\WarBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('BzhCoreBundle' => 'Bzh\\CoreBundle\\Entity', 'BzhWarBundle' => 'Bzh\\WarBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6c1d161d5ef559286f9e6a40348509a3abe8ac123ab8758768e183f2a226d733');
    ...
    protected function getIvoryCkEditor_ConfigManagerService()
    {
        ...
        $instance->setConfig('my_config', array('toolbar' => array(0 => array(0 => 'Bold', 1 => 'Italic', 2 => 'Underline', 3 => 'Strike', 4 => '-', 5 => 'RemoveFormat'), 1 => array(0 => 'Styles'), 2 => array(0 => 'Format'), 3 => array(0 => 'Font'), 4 => array(0 => 'FontSize'), 5 => array(0 => 'TextColor', 1 => 'BGColor'), 6 => '/', 7 => array(0 => 'NumberedList', 1 => 'BulletedList', 2 => '-', 3 => 'Outdent', 4 => 'Indent', 5 => '-', 6 => 'Blockquote', 7 => 'CreateDiv', 8 => '-', 9 => 'JustifyLeft', 10 => 'JustifyCenter', 11 => 'JustifyRight', 12 => 'JustifyBlock'), 8 => array(0 => 'Link', 1 => 'Unlink', 2 => 'Anchor'), 9 => array(0 => 'Image', 1 => 'Table', 2 => 'HorizontalRule', 3 => 'SpecialChar', 4 => 'Smiley'))));
        $instance->setConfig('full', array('toolbar' => array(0 => array(0 => 'Source', 1 => '-', 2 => 'NewPage', 3 => 'Preview', 4 => 'Print', 5 => '-', 6 => 'Templates'), 1 => array(0 => 'Cut', 1 => 'Copy', 2 => 'Paste', 3 => 'PasteText', 4 => 'PasteFromWord', 5 => '-', 6 => 'Undo', 7 => 'Redo'), 2 => array(0 => 'Find', 1 => 'Replace', 2 => '-', 3 => 'SelectAll', 4 => '-', 5 => 'Scayt'), 3 => array(0 => 'Form', 1 => 'Checkbox', 2 => 'Radio', 3 => 'TextField', 4 => 'Textarea', 5 => 'SelectField', 6 => 'Button', 7 => 'ImageButton', 8 => 'HiddenField'), 4 => '/', 5 => array(0 => 'Bold', 1 => 'Italic', 2 => 'Underline', 3 => 'Strike', 4 => 'Subscript', 5 => 'Superscript', 6 => '-', 7 => 'RemoveFormat'), 6 => array(0 => 'NumberedList', 1 => 'BulletedList', 2 => '-', 3 => 'Outdent', 4 => 'Indent', 5 => '-', 6 => 'Blockquote', 7 => 'CreateDiv', 8 => '-', 9 => 'JustifyLeft', 10 => 'JustifyCenter', 11 => 'JustifyRight', 12 => 'JustifyBlock', 13 => '-', 14 => 'BidiLtr', 15 => 'BidiRtl'), 7 => array(0 => 'Link', 1 => 'Unlink', 2 => 'Anchor'), 8 => array(0 => 'Image', 1 => 'FLash', 2 => 'Table', 3 => 'HorizontalRule', 4 => 'SpecialChar', 5 => 'Smiley', 6 => 'PageBreak', 7 => 'Iframe'), 9 => '/', 10 => array(0 => 'Styles', 1 => 'Format', 2 => 'Font', 3 => 'FontSize', 4 => 'TextColor', 5 => 'BGColor'), 11 => array(0 => 'Maximize', 1 => 'ShowBlocks'), 12 => array(0 => 'About'))));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Bzh\WarBundle\Twig\CalcDateTimeExtension A Bzh\WarBundle\Twig\CalcDateTimeExtension instance
     */
    protected function getOcPlatform_Twig_AntispamExtensionService()
    {
        return $this->services['oc_platform.twig.antispam_extension'] = new \Bzh\WarBundle\Twig\CalcDateTimeExtension($this->get('war.dates.calc'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'BzhCoreBundle::bootstrap_4_horizontal_layout.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'IvoryCKEditorBundle:Form:ckeditor_widget.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'BzhCoreBundle::bootstrap_4_horizontal_layout.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'StofDoctrineExtensionsBundle', 8 => 'AsseticBundle', 9 => 'IvoryCKEditorBundle', 10 => 'BzhCoreBundle', 11 => 'BzhWarBundle', 12 => 'BzhStatsBundle', 13 => 'DebugBundle', 14 => 'WebProfilerBundle', 15 => 'SensioDistributionBundle', 16 => 'SensioGeneratorBundle', 17 => 'DoctrineFixturesBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        $instance->addExtension($this->get('ivory_ck_editor.twig_extension'));
        $instance->addExtension($this->get('oc_platform.twig.antispam_extension'));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\DumpExtension($this->get('var_dumper.cloner')));
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension());
        $instance->addGlobal('app', $c);
        $instance->addGlobal('webmaster', 'Gus');
        $instance->addGlobal('version', '0.0.1');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Bzh\\CoreBundle/Resources/views'), 'BzhCore');
        $instance->addPath(($this->targetDirs[3].'\\src\\Bzh\\WarBundle/Resources/views'), 'BzhWar');
        $instance->addPath(($this->targetDirs[3].'\\src\\Bzh\\StatsBundle/Resources/views'), 'BzhStats');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('205d6a417e857d6914b9c2b58e1149ea06d4da3a');
    }
    ...
    /**
     * Gets the 'war.dates.calc' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bzh\WarBundle\Services\CalcDateTime A Bzh\WarBundle\Services\CalcDateTime instance
     */
    protected function getWar_Dates_CalcService()
    {
        return $this->services['war.dates.calc'] = new \Bzh\WarBundle\Services\CalcDateTime();
    }

    /**
     * Gets the 'war.targets.create' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bzh\WarBundle\Services\CreateTargets A Bzh\WarBundle\Services\CreateTargets instance
     */
    protected function getWar_Targets_CreateService()
    {
        return $this->services['war.targets.create'] = new \Bzh\WarBundle\Services\CreateTargets($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57ac9e84aa93a2.33017270')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BzhCoreBundle' => 'Bzh\\CoreBundle\\BzhCoreBundle',
                'BzhWarBundle' => 'Bzh\\WarBundle\\BzhWarBundle',
                'BzhStatsBundle' => 'Bzh\\StatsBundle\\BzhStatsBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'bzhcaller',
            'database_user' => 'postgres',
            'database_password' => 322158,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '205d6a417e857d6914b9c2b58e1149ea06d4da3a',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '205d6a417e857d6914b9c2b58e1149ea06d4da3a',
            ...
            'twig.form.resources' => array(
                ...
                2 => 'BzhCoreBundle::bootstrap_4_horizontal_layout.html.twig',
            ),
            ...
            'assetic.bundles' => array(
                ...
                7 => 'StofDoctrineExtensionsBundle',
                8 => 'AsseticBundle',
                9 => 'IvoryCKEditorBundle',
                10 => 'BzhCoreBundle',
                11 => 'BzhWarBundle',
